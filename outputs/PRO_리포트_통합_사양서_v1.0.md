...
1. [프로젝트 개요](#1-프로젝트-개요)
2. [설계 철학 및 원칙](#2-설계-철학-및-원칙)
3. [화면 구조 (7개 섹션)](#3-화면-구조-7개-섹션)
4. [데이터 지표 정의](#4-데이터-지표-정의)
5. [API 명세 및 데이터 소스](#5-api-명세-및-데이터-소스)
6. [비즈니스 로직](#6-비즈니스-로직)
7. [예외 처리 및 검증](#7-예외-처리-및-검증)
8. [참고 자료](#8-참고-자료)
...
┌─────────────────────────────────────────────────────────┐
│ 이번 달 총 매출                                          │
│ 8,364,117원                     ↑ 78% (지난달 대비)     │
│ ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ │
│                                                         │
│ PRO가 만든 매출                  다음 목표               │
│ 3,200,000원 (38%)               200만원 더 팔면         │
│                                 업종 평균 달성!          │
│                                                         │
│ 3개월 추세: [미니 그래프 ━━━━━━━━━━━▲]                │
└─────────────────────────────────────────────────────────┘
...
│ 💡 이번 달 가장 중요한 발견                              │
│                                                         │
│ "재구매율 2.7% → 업종 평균(10%) 미달."                  │
│ "CRM 자동 메시지 활성화로 재구매율 2배 증가 가능"         │
│                                                         │
│ [CRM 자동 메시지 설정하기]                               │
└─────────────────────────────────────────────────────────┘
```
...
메시지:
  ...
  - 해결 방안: "{PRO 기능} 활성화로 {지표명} {증가율}배 증가 가능"
...
│                                                         │
│ Red Indicator:                                         │
│ • CONVERSION: 평균(3.5%) 대비 1.1%p 낮음               │
│   → 프로모션 활성화로 전환율 +30% 개선 가능              │
│ • RETENTION: 평균(10%) 대비 7.3%p 낮음                 │
│   → CRM 자동 메시지로 재구매율 2배 증가 가능             │
└─────────────────────────────────────────────────────────┘
```
...
│ PRO 성과                                                 │
│                                                         │
│ 1. PRO가 만든 매출 (총 3,200,000원)                      │
│    ├─ SEO (검색 유입): 800,000원                         │
│    ├─ CRM (자동 메시지): 0원 → [넛지 표시]               │
│    ├─ 프로모션 (할인): 1,200,000원                       │
│    └─ 채널 판매 (연동 마켓): 1,200,000원                 │
│                                                         │
│ 2. 절약한 시간/비용                                      │
│    - 총 480.4시간 절약 (월평균 16시간/일)                │
│    - 약 700,000원 상당 (시급 10,000원 기준)              │
│                                                         │
│ 3. 미사용 PRO 기능 (넛지)                                │
│    - CRM 자동 메시지: 활성화 시 +200만원/월 예상         │
│    [지금 설정하기]                                       │
└─────────────────────────────────────────────────────────┘
```
...
- **비교 분석 문서**: [Wiki 페이지](https://wiki.simplexi.com/pages/viewpage.action?pageId=2802894087)
